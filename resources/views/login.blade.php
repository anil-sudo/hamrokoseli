...
<body class="bg-[#F5E8D6] min-h-screen flex items-center justify-center font-sans p-0 m-0">
                ...
                <div class="flex flex-col gap-4 max-w-md">
                    ...
                    <div class="flex items-start gap-4 bg-black/25 backdrop-blur-sm border border-white/10 p-4 rounded-2xl transition hover:bg-black/35 duration-300">
                        ...
                        <div>
                            ...
                            <p class="text-white/70 text-xs mt-0.5">100% protected transactions</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4 bg-black/25 backdrop-blur-sm border border-white/10 p-4 rounded-2xl transition hover:bg-black/35 duration-300">
                        ...
                        <div>
                            <h3 class="text-white font-bold text-xs tracking-wider uppercase">Local Pickup</h3>
                            <p class="text-white/70 text-xs mt-0.5">Convenient neighborhood collection</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4 bg-black/25 backdrop-blur-sm border border-white/10 p-4 rounded-2xl transition hover:bg-black/35 duration-300">
                        ...
                        <div>
                            <h3 class="text-white font-bold text-xs tracking-wider uppercase">Support Artisans</h3>
                            <p class="text-white/70 text-xs mt-0.5">Directly fund local creators</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="lg:w-1/2 flex items-center justify-center p-6 md:p-12 lg:p-16 bg-[#F5E8D6]">
            ...
            <div class="bg-[#FFF7EF] w-full max-w-md rounded-3xl shadow-xl p-8 md:p-10 border border-[#ebd7be]/40 relative">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-slate-500 text-xs font-semibold tracking-wide">Sign in to continue supporting local business.</p>
                </div>
    ...
    <!-- Script to toggle password visibility inside the page -->
    <script>
