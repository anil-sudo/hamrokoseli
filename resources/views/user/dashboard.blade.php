                        ...
                        @forelse($topDiscounts as $product)
                            <div class="flex flex-col items-start gap-5 p-4 hover:bg-(--card-dark)/7 rounded-2xl transition-all group">
                                <div class="flex flex-row lg:flex-col gap-7 w-full">
                                    ...
                                    <div class="flex-1">
                                        <a href="{{ route('viewdetails', $product->id) }}" class="font-medium text-(--text-dark) group-hover:text-(--primary-color) transition line-clamp-1">
                                            {{ $product->name }}
                                        </a>
                                ...
                                <div class="w-full">
                                    <a href="{{ route('viewdetails', $product->id) }}" class="block text-center bg-(--primary-color)/90 text-white w-full px-6 py-3 rounded-2xl text-sm font-medium hover:bg-(--primary-color) transition">
                                        Grab Deal
                                    </a>
                                </div>
                            </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                @forelse($recommendedProducts as $product)
                    <div class="bg-(--card-bg) rounded-3xl overflow-hidden group shadow-sm hover:shadow-lg transition-all duration-300">
                        ...
                        <div class="p-4">
                            <a href="{{ route('viewdetails', $product->id) }}" class="font-medium text-sm line-clamp-2 hover:text-(--primary-color) transition">
                                {{ $product->name }}
                            </a>
