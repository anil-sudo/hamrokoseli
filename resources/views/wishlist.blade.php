    ...
    <template id="wishlist-card-template">
        <div class="bg-white rounded-2xl sm:rounded-3xl overflow-hidden border border-[#ebd7be]/40 shadow-sm hover:shadow-md transition duration-300 flex flex-col group relative">
            <div class="relative w-full aspect-[4/3] overflow-hidden">
                ...
                <button type="button" class="wishlist-delete-btn absolute top-3 right-3 bg-white hover:bg-red-50 text-[#C65A3A] hover:text-red-600 rounded-full w-9 h-9 flex items-center justify-center shadow-md transition hover:scale-105 active:scale-95 cursor-pointer" title="Remove from wishlist">
            ...
            <div class="p-3 sm:p-5 flex-grow flex flex-col justify-between">
                <div class="mb-4">
                    ...
                    <p class="wishlist-desc text-xs sm:text-sm text-[#3A2A1F]/70 line-clamp-2 leading-relaxed">
                        Product description goes here.
                    </p>
                </div>
                <div class="mt-auto space-y-4">
                    <span class="wishlist-price text-[#C65A3A] font-extrabold text-base sm:text-lg block">रू Price</span>
                    <button type="button" class="wishlist-add-cart-btn w-full flex items-center justify-center gap-2 bg-[#b55b3d] hover:bg-[#a04f33] text-white text-sm font-bold py-3 px-4 rounded-xl shadow-sm hover:shadow transition duration-300">
                        <i class="fa-solid fa-cart-shopping text-xs"></i> Add to Cart
                    </button>
                </div>
            </div>
