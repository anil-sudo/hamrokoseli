...
<div class="bg-white">
  ...
  <header class="relative bg-white">
    <p class="flex h-10 items-center justify-center bg-indigo-600 px-4 text-sm font-medium text-white sm:px-6 lg:px-8">Get free delivery on orders over Rs.100</p>
            ...
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="size-6">
              <path d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" stroke-linecap="round" stroke-linejoin="round" />
                ...
                <a href="#" class="flex items-center gap-2">
                    <span class="sr-only">Hamro Koseli</span>

                    <span class="text-xl font-semibold tracking-tight text-orange-600 hover:text-orange-700 transition">
                    Hamro
                    </span>

                    <span class="text-xl font-semibold tracking-tight text-gray-900 hover:text-gray-700 transition">
                    Koseli
                    </span>
                </a>
                </div>
