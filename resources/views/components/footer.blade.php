...
<footer class="p-4 bg-white sm:p-6 dark:bg-gray-800">
    <div class="mx-auto max-w-screen-xl">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© {{ now()->year }} <a href="{{ route('home') }}" class="hover:underline">{{ config('app.name') }}</a>
            </span>
            <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                ...
                <a href="https://x.com" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
