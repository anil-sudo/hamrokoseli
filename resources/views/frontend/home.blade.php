    ...
    <div class="mt-6 grid grid-cols-2 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
      <div class="group relative">
        ...
        <div class="mt-4 flex justify-between">
          ...
          <p class="text-sm font-medium text-gray-900">Rs.35</p>
        </div>
      </div>
      <div class="group relative">
...
<div class="bg-white">
  <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
    <h2 class="text-2xl font-bold tracking-tight text-gray-900">Most Sold Products</h2>
     <br>
    ...
    <div class="grid grid-cols-2 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
      <a href="#" class="group">
        ...
        <p class="mt-1 text-lg font-medium text-gray-900">Rs.48</p>
      </a>
      <a href="#" class="group">
        ...
        <p class="mt-1 text-lg font-medium text-gray-900">Rs.35</p>
      </a>
      <a href="#" class="group">
        ...
        <p class="mt-1 text-lg font-medium text-gray-900">Rs.89</p>
      </a>
      <a href="#" class="group">
      ...
      <a href="#" class="group">
        ...
        <p class="mt-1 text-lg font-medium text-gray-900">Rs.64</p>
      </a>
      <a href="#" class="group">
        ...
        <p class="mt-1 text-lg font-medium text-gray-900">Rs.39</p>
      </a>
      <a href="#" class="group">
        ...
        <p class="mt-1 text-lg font-medium text-gray-900">Rs.50</p>
      </a>
      <a href="#" class="group">
        ...
        <p class="mt-1 text-lg font-medium text-gray-900">Rs.32</p>
      </a>
    </div>
  </div>
</div>
