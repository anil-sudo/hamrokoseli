                ...
                <div class="space-y-5">
                    <div>
                        <label class="block text-sm font-medium text-(--text-dark) mb-2">Base Price (Rs.) <span
                                class="text-(--secondary-color)">*</span></label>
                        <input type="number" id="base_price" name="base_price" value="0" step="1"
                            min="0" required
                            class="w-full px-5 py-4 bg-(--card-dark) border border-(--bg-color)/30 rounded-xl text-base focus:outline-none focus:border-(--secondary-color) transition duration-200">
                        <p class="error text-red-500 text-sm mt-1 hidden"></p>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" id="discounted_price" name="discounted_price" value="0"
                                step="1" min="0"
                                class="w-full px-5 py-4 bg-(--card-dark) border border-(--bg-color)/30 rounded-xl text-base focus:outline-none focus:border-(--secondary-color) transition duration-200">
                            <p class="error text-red-500 text-sm mt-1 hidden"></p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-(--text-dark) mb-2">SKU <span
                                    class="text-(--secondary-color)">*</span></label>
                            <input type="text" id="sku" name="sku" placeholder="e.g.HK-001" required
                                class="w-full px-1.5 py-4 bg-(--card-dark) border border-(--bg-color)/30 rounded-xl text-base focus:outline-none focus:border-(--secondary-color) transition duration-200">
                            <p class="error text-red-500 text-sm mt-1 hidden"></p>
                        </div>
                    </div>
